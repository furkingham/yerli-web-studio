...
export const turkiyeIlIlce: Record<string, string[]> = {
  ...
  "Van": ["Bahçesaray","Başkale","Çatak","Çaldıran","Edremit","Erciş","Gevaş","Gürpınar","İpekyolu","Muradiye","Özalp","Saray","Tuşba"],
...
// İl listesini alfabetik sıralı olarak al
export const iller: string[] = Object.keys(turkiyeIlIlce).sort((a, b) => a.localeCompare(b, 'tr'));

// Bir ile ait ilçeleri al
export const getIlceler = (il: string): string[] => {
  return turkiyeIlIlce[il] || [];
};
